...
// this function creates a three-column table and adds it to the screen
   ...
   var tocTool2 = 'اضغط ليتم الترتيب بحسب التاريخ';
   var tocHead3 = 'الاقسام';
   var tocTool3 = '';
   if (sortBy == "titleasc") { 
      tocTool1 += ' (descending)';
   ...
   tocTable += '<a href="javascript:كل المواضيع();" title="' + tocTool3 + '">' + tocHead3 + '</a>';
   tocTable += '</td>';
   tocTable += '</tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<span class="toc-note">عدد المواضيع ' + postTitle.length + ' مواضيع<br/></span>'; }
   else {
      var tocNote = '<span class="toc-note">عرض ' + numDisplayed + ' posts labeled \'';
